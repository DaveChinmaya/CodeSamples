...
ice_cream_flavor = ["Chocolate", "Mint Chocolate Chip"]
...
for flavor in ice_cream_flavors:
    ...
    prompt = f"""For the ice cream flavor listed below, replace the {flavor} with its
    spanish name. Return only the single Spanish word (no explanation).    
    """
    ### --------------- ###
    print_llm_response(prompt)
