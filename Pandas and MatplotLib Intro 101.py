...
#print(data[data["Year"]==2015])
honda_data = (data[data["Model"]=="Honda City VX"])
len(honda_data)
...
# WRITE YOUR CODE HERE
plt.scatter(honda_data["Year"], honda_data["Price"], color='red')
...
prompt = f"""Create a pie chart from {honda_data}. The pie chart should show
how many cars were sold each {honda_data["Year"]}"""
