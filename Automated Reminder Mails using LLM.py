...
# If you **need a fresh copy of the assignment (reset)**, follow the [instructions](https://learn.deeplearning.ai/faq/refreshing-your-workspace) under the heading, "`Refreshing your Workspace`".
# 
...
prompt = f"""
Please write a polite email to {person_name} 
reminding them to return the book {book_name} by {book_author}. 
The book was due on {due_date}.
"""
...
# ### Submission Note:
# If you have passed all the tests up to this point, you can submit your assignment. Save your work by clicking the 💾 icon at the top left, then click the <span style="color: blue; font-weight: bold;">Submit assignment</span> button at the top right. Good luck! 
# 
